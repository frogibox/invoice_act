...
- После внесения правок в код приложения (src/) обязательно запускать тесты и при появлении ошибок исправлять их
- Когда тесты станут зелеными - создать коммит и запушить изменения
